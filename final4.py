...
class ejes(Operator):
    ...
    def crearEjePlano(altura):
        eje = bpy.ops.mesh.primitive_cube_add(enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(0.4, objectselection_props.thickness, zInicial))
        return eje
