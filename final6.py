...
class ejes(Operator):
    ...
    def crearEjePlano(alturaObjReal, grosorLamina):
        anchuraPorDefecto = 0.4
        alturaEje = alturaObjReal + grosorLamina
        eje = bpy.ops.mesh.primitive_cube_add(enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(grosorLamina, anchuraPorDefecto, alturaEje))
        return eje
...
class base(Operator):
    ...
    def crearBaseSimple(largoX, anchoY, grosorZ):
        base = bpy.ops.mesh.primitive_cube_add(enter_editmode=False, align='WORLD', location=(0, 0, 0), scale=(largoX, 0.2, grosorZ))
        return base
...
class bisectioner(Operator):
    ...
    def execute(self, context):
        ...
        escaladoX = (xReal)/ xInicial
        escaladoY = (yReal)/ yInicial
        escaladoZ = zReal
        ...
        print("LA PUTA ZREAL ES")
        print(zReal)
        print("LA PUTA ZREAL ES")
        print(zReal/100)
        #ejes.crearEjePlano(zReal, grosor)
        base.crearBaseSimple(xReal/100, yReal/100, (zReal/100)/zInicial)
