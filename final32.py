    ...
    def execute(self, context):
        ...
        if longitudMateriaReal/xReal < 1:
            ...
            if (objVerticalesIniciales * yReal) > anchuraMaterialReal:
                ...
                print("EL NUMERO DE PIEZAS HORIZOTALES ES")
                print(objHorizontales)
                print("EL NUMERO DE PIEZAS VERTICALES ES")
                print(objVerticales)
        ...
        bpy.context.scene.objects["GPencil"].select_set(True)  #Selecciono la luz
        bpy.ops.object.delete(use_global=False) #lo elimino
        ...
        for j in range(numeroCortes):
            ...
            bpy.ops.object.origin_set(type='ORIGIN_GEOMETRY', center='MEDIAN')  #Hago el centro de la lamina para moverlo
            bpy.ops.transform.translate(value=(escaladoX, escaladoY, 0), orient_axis_ortho='X', orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', constraint_axis=(False, False, True), mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
        ...
        #j=numeroCortes-1
        print("Obj HORIZONTALES y VERTICALES")
        print(objHorizontalesIniciales)
        print(objVerticalesIniciales)
        n=0
        j=0
        i=1
        x = numeroCortes * -1
        
        #for n in range(numeroCortes):
        for i in range(objVerticalesIniciales):
            for x in range(objHorizontalesIniciales):
                if n != numeroCortes:
                    ...
                    bpy.ops.object.origin_set(type='ORIGIN_GEOMETRY', center='MEDIAN')  #Hago el centro de la lamina para moverlo
                    #if x != 0:
                     #   bpy.ops.transform.translate(value=(0, escaladoY*2**x, 0), orient_axis_ortho='X', orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', constraint_axis=(False, False, True), mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
                    if j != -1:
                        bpy.ops.transform.translate(value=((escaladoX*2)*(i), (escaladoY*2)*(x), 0), orient_axis_ortho='X', orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', constraint_axis=(False, False, True), mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
            ...
            #bpy.ops.transform.translate(value=((escaladoX*2)*(i), 0, 0), orient_axis_ortho='X', orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', constraint_axis=(False, False, True), mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
        ...
        ejes.crearEjePlano(escaladoZ, 0.5,grosor)
        ...
        bpy.ops.transform.translate(value=(-escaladoZ, 0.5, 0), orient_axis_ortho='X', orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', constraint_axis=(True, False, False), mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
        ...
        base.crearBaseSimple(escaladoX, escaladoY, grosor)
        bpy.ops.transform.translate(value=(-escaladoX, -escaladoY, 0), orient_axis_ortho='X', orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', constraint_axis=(True, False, False), mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
        bpy.ops.object.convert(target='GPENCIL') 
        print("largo y ancho de los cojones")
        print( longitudMateriaReal)
        print(anchuraMaterialReal)
        plantilla.crearPlantilla(objectselection_props.lengthSheet, objectselection_props.widthSheet)
        bpy.ops.transform.translate(value=(objectselection_props.lengthSheet/2, objectselection_props.widthSheet/2, 0), orient_axis_ortho='X', orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', constraint_axis=(True, False, False), mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
