...
class bisectioner(Operator):
    ...
    def execute(self, context):
        ...
        ejes.crearEjePlano(zInicial, 0.03,grosor / 10)
        ...
        bpy.ops.transform.translate(value=(0, 0, 0.05), orient_axis_ortho='X', orient_type='GLOBAL', orient_matrix=((1, 0, 0), (0, 1, 0), (0, 0, 1)), orient_matrix_type='GLOBAL', constraint_axis=(False, False, True), mirror=False, use_proportional_edit=False, proportional_edit_falloff='SMOOTH', proportional_size=1, use_proportional_connected=False, use_proportional_projected=False)
        ...
        i=0.000
        primerCorte = escaladoZ * 2 - grosorInicial /100
        for j in range(numeroCortes):
          ...
          i += (grosor*2) /100 #ahora estaria en mm reales
