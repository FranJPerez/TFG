...
class OBJECTSELECTION_Panel(Panel):
    ...
    def draw(self, context):
        ...
        box.label(text="Altura del objeto en cm:")
        box.prop(cell_props, "objectHigh")
        
        box.label(text="Grosor de la lamina en mm:")
        box.prop(cell_props, "thickness")
        
        box.label(text="Largo de la lamina en cm:")
        box.prop(cell_props, "lengthSheet")
        
        box.label(text="Ancho de la lamina en cm:")
